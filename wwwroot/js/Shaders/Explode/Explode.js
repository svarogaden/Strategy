...
// AsyncLoader.explode["explosion"]


//let materialExplode = new THREE.ShaderMaterial({

//	uniforms: {
//		//tExplosion: { type: "t", value: THREE.ImageUtils.loadTexture('explosion.png') },
//		tExplosion: { type: "t", value: AsyncLoader.explode["explosion"] },
...
//let meshExplode = new THREE.Mesh(new THREE.IcosahedronBufferGeometry(20, 5), materialExplode);
...
//	materialExplode.uniforms['time'].value = .00025 * (Date.now() - start);
